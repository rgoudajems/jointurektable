...
public class SimpleJoinTabContAdrPartKey {
 
    public static void main(final String[] args) throws Exception {
    	final String contactTopic = "partkey-contact";
    	final String adresseTopic = "partkey-adresse";
    	final String jointureTopic = "partkey-contact-adresse";
        Properties config = new Properties();
        config.put(StreamsConfig.APPLICATION_ID_CONFIG, "join-partkey-table-adresse-contact");
       ...
       //Les données contacts 
        List<KeyValue<String, String>> contactRecords = Arrays.asList(
        	new KeyValue<>("C3-R1", "R1"),		
            new KeyValue<>("C1-R2", "R2"),
            new KeyValue<>("C2-R3", "R3"),
            new KeyValue<>("C1-R4", "R1"),
            new KeyValue<>("C2-R5", "R1"), 
            new KeyValue<>("C3-R6", "R3"),
            new KeyValue<>("C2-R7", "R2")  
