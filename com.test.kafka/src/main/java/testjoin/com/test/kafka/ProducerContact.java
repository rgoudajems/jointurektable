...
public class ProducerContact {
    ...
    public static void main(String[] argv)throws Exception {
       /* if (argv.length != 1) {
        ...
        configProperties.put(StreamsConfig.STATE_DIR_CONFIG , "/tmp"); 
